  ...
  class SheetContent < Base
    ...
    def default_attrs
      {
        ...
        class: "fixed pointer-events-auto z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 #{@side_classes}"
      }
    end
    ...
    def close_button
      button(
        ...
        data_action: "click->rbui--sheet-content#close keydown.esc->rbui--sheet-content#close"
      ) do
        svg(
          width: "15",
          height: "15",
